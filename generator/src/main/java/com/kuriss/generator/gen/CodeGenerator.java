...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        String moduleName = args.length > 0 ? args[0] : "member"; // 默认模块名为 "member"
        String dbName = args.length > 1 ? args[1] : "train_member"; // 默认数据库名为 "train_member"
        String tableName = args.length > 2 ? args[2] : "passenger"; // 单个表名，默认是 "example_table"
        ...
        String dbUsername = "train_member"; // 替换为你的数据库用户名
